...
| D012 | Accepted — P03, amended | Use the continuous Wyman/Sloan/Shirley analytic CIE 1931 fit, hard-clamp authored emission to 470–620 nm, reserve 470 nm blue for life and 620 nm red for death, then use XYZ-to-linear-sRGB conversion, neutral-lift gamut mapping, 1.18× source chroma, per-look saturation (+0.14 Porcelain), fixed exposure, Three.js ACES filmic tone mapping, and one final sRGB transfer. | Creative owner + implementation owner | Preserves an unambiguous life/death color axis while making causal emission richer; neutral architecture remains neutral and viewport/capture parity stays explicit. See the 2026-08-07 amendments in `adr/0002-linear-spectral-output.md`. |
